...
void main() {
  group('ReedmaceRouter', () {
    ...
    setUp(() {
      ...
      router.register(RouteDefinition.dynamicMock('path/hello/world', 'GET')
          .emptyRegistration());
      router.register(
          RouteDefinition.dynamicMock('path/hello', 'GET').emptyRegistration());
      router.register(
          RouteDefinition.dynamicMock('path/a', 'GET').emptyRegistration());
      router.register(
          RouteDefinition.dynamicMock('path/b', 'GET').emptyRegistration());
      router.register(
          RouteDefinition.dynamicMock('path/c', 'GET').emptyRegistration());
      router.register(RouteDefinition.dynamicMock('path/hello', 'POST')
          .emptyRegistration());
      router.register(RouteDefinition.dynamicMock('path/hello/world', 'ALL')
          .emptyRegistration());
      router.register(RouteDefinition.dynamicMock('path/:hello', 'GET')
          .emptyRegistration());
      router.register(RouteDefinition.dynamicMock('path/:hello/world', 'GET')
          .emptyRegistration());
      router.register(
          RouteDefinition.dynamicMock('path/:hello/world/:test', 'GET')
              .emptyRegistration());
    });
    ...
    test('find returns route when route matches', () {
      ...
      expect(
          router.lookup(cUri, "PATCH"), isRouteDefinition("path/hello/world"));
    });
    ...
    test('find returns route when route matches with variable path', () {
      ...
      expect(
          router.lookup(bUri, "GET"), isRouteDefinition("path/:hello/world"));
      expect(router.lookup(cUri, "GET"),
          isRouteDefinition("path/:hello/world/:test"));
    });

    test('stores correct dynamic segment values', () {
      var result = router.lookup(
          Uri.parse("http://localhost:8080/path/variable/world/test"), 'GET');
      print(result!.$2);
