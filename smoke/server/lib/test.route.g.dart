...
const sync_descriptor = gen.RouteDefinition(
    ...
    _$sync);
FutureOr<gen2.Res<gen3.String>> _$sync(List<dynamic> args) =>
    gen4.sync(args[0]);
const getTest_descriptor = gen.RouteDefinition(
    ...
    _$getTest);
FutureOr<gen2.Res<gen3.String>> _$getTest(List<dynamic> args) =>
    gen4.getTest(args[0]);
const postTest_descriptor = gen.RouteDefinition(
    ...
    [
      gen.MethodArgument(
          gen.QualifiedTypeTreeN<gen0.Req<gen3.String>, gen0.Req<dynamic>>(
              [gen.QualifiedTerminal<gen3.String>()]),
          false,
          'req',
          [])
    ...
    _$postTest);
FutureOr<gen2.Res<gen3.String>> _$postTest(List<dynamic> args) =>
    gen4.postTest(args[0]);
const getUser_descriptor = gen.RouteDefinition(
    ...
    _$getUser);
FutureOr<gen2.Res<gen3.String>> _$getUser(List<dynamic> args) =>
    gen4.getUser(args[0], args[1]);
const getQuery_descriptor = gen.RouteDefinition(
    ...
    [
      gen.MethodArgument(
          ...
          []),
      gen.MethodArgument(
          gen.QualifiedTerminal<gen3.String>(), false, '\$skip', []),
      gen.MethodArgument(
          gen.QualifiedTerminal<gen3.String>(), true, '\$limit', [])
    ],
    _$getQuery);
FutureOr<gen2.Res<gen3.String>> _$getQuery(List<dynamic> args) =>
    gen4.getQuery(args[0], args[1], args[2]);
const getHeaders_descriptor = gen.RouteDefinition(
    ...
    [
      gen.MethodArgument(
          ...
          []),
      gen.MethodArgument(
          gen.QualifiedTerminal<gen3.String>(), false, '\$\$Authorization', []),
      gen.MethodArgument(gen.QualifiedTerminal<gen3.String>(), true, 'a',
          [gen1.HeaderParam('A')]),
      gen.MethodArgument(
          gen.QualifiedTerminal<gen3.String>(), true, 'b', [gen1.HeaderParam()])
    ],
    _$getHeaders);
FutureOr<gen2.Res<gen3.String>> _$getHeaders(List<dynamic> args) =>
    gen4.getHeaders(args[0], args[1], args[2], args[3]);
const getUntypedResponse_descriptor = gen.RouteDefinition(
    'getUntypedResponse',
    gen1.POST('/untyped'),
    [gen1.POST('/untyped')],
    gen.QualifiedTypeTreeN<gen2.Res<dynamic>, gen2.Res<dynamic>>(
        [gen.QualifiedTerminal<dynamic>()]),
    [
      gen.MethodArgument(
          gen.QualifiedTypeTreeN<gen0.Req<dynamic>, gen0.Req<dynamic>>(
...
FutureOr<gen2.Res<dynamic>> _$getUntypedResponse(List<dynamic> args) =>
    gen4.getUntypedResponse(args[0]);
const getPerson_descriptor = gen.RouteDefinition(
    'getPerson',
    gen1.GET('/person'),
    [gen1.GET('/person')],
    gen.QualifiedTypeTreeN<gen2.Res<gen5.Person>, gen2.Res<dynamic>>(
        [gen.QualifiedTerminal<gen5.Person>()]),
    [
      gen.MethodArgument(
          gen.QualifiedTypeTreeN<gen0.Req<dynamic>, gen0.Req<dynamic>>(
              [gen.QualifiedTerminal<dynamic>()]),
    ...
    _$getPerson);
FutureOr<gen2.Res<gen5.Person>> _$getPerson(List<dynamic> args) =>
    gen4.getPerson(args[0]);
const extractName_descriptor = gen.RouteDefinition(
    ...
    [
      gen.MethodArgument(
          gen.QualifiedTypeTreeN<gen0.Req<gen5.Person>, gen0.Req<dynamic>>(
              [gen.QualifiedTerminal<gen5.Person>()]),
          false,
          'req',
          [])
    ...
    _$extractName);
FutureOr<gen2.Res<gen3.String>> _$extractName(List<dynamic> args) =>
    gen4.extractName(args[0]);
const anotherTest_descriptor = gen.RouteDefinition(
    ...
    _$anotherTest);
FutureOr<gen2.Res<gen3.String>> _$anotherTest(List<dynamic> args) =>
    gen4.anotherTest(args[0]);
